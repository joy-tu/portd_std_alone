...
//@@ add by Kevin
#define LBS_PRIV_SET_MFG		SIOCIWFIRSTPRIV			/* RF test functions */
#define LBS_PRIV_SET_HWADDR		SIOCIWFIRSTPRIV + 1		/* MAC address */
#define LBS_PRIV_SET_REGION		SIOCIWFIRSTPRIV + 2		/* region code */
#define LBS_PRIV_SET_FROAM		SIOCIWFIRSTPRIV + 3		/* enable/disable fast roaming */
#define LBS_PRIV_DO_KA			SIOCIWFIRSTPRIV + 4		/* send keep alive packet */
//@@ end
...
typedef struct wireless_scan
{
	...
	int		has_maxbitrate;
//@@ add by Kevin
#define IW_CRYPT_NONE			0
#define IW_CRYPT_WEP			1
#define IW_CRYPT_WPA_PSK_TKIP	2
#define IW_CRYPT_WPA_PSK_CCMP	3
#define IW_CRYPT_WPA_EAP_TKIP	4
#define IW_CRYPT_WPA_EAP_CCMP	5
#define IW_CRYPT_WPA2_PSK_TKIP	6
#define IW_CRYPT_WPA2_PSK_CCMP	7
#define IW_CRYPT_WPA2_EAP_TKIP	8
#define IW_CRYPT_WPA2_EAP_CCMP	9
	char crypt;
//@@ end
} wireless_scan;
 ...
 */
int iw_get_site_survey(int skfd, char *ifname, wireless_scan_head *context);
int iw_site_survey(int skfd, char *ifname, wireless_scan_head *context);
